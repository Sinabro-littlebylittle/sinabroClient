...
public class RemoveListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ask_add_or_cancel_bookmark_dialog = new Dialog(RemoveListActivity.this);  // Dialog 초기화
        ...
        placeInfo_dialog = new Dialog(RemoveListActivity.this);  // Dialog 초기화
        ...
        binding.removeListBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checked_toggle_cnt == 0) {
                    new ToastWarning(getResources().getString(R.string.toast_remove_list_failed), RemoveListActivity.this);
                    return;
                }
    ...
    public void showDialog_ask_accept_add_or_remove_list() {
        ...
        ask_add_or_cancel_bookmark_dialog.findViewById(R.id.yesBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ask_add_or_cancel_bookmark_dialog.dismiss(); // 다이얼로그 닫기
                new ToastSuccess(getResources().getString(R.string.toast_remove_list_success), RemoveListActivity.this);
